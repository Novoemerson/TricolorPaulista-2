...
def gerar_texto(noticia):
    resposta = co.generate(
        model="command",
       prompt = "São Paulo encaminha contratação do atacante Juan Dinenno, do Cruzeiro. Argentino 30 anos deve chegar ao Tricolor por empréstimo até o fim do ano
                         08/06/2025 21h20
...
noticia_gerada = resposta.generations[0].text
